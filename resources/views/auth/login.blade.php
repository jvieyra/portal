...
@section('content')
<!-- login employees -->
<div class="page-wrapper login-employees pa-0 ma-0 auth-page" style="background-image: url({{ asset('/images/auth/admin/admin-login-bg2.jpg') }})">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <div class="mb-30">
                            ...
                            <h6 class="text-center nonecase-font text-white"> Administrador </h6>
                        </div>
                        <div class="form-wrap">
