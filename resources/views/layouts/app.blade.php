...
<head>
  <meta charset="UTF-8" />
	...
	<meta name="description" content="Portal ITJ administracion de contenidos ITJ" />
	<meta name="keywords" content="Portal Admin ITJ Vallereal,administracion, Campus ITJ Vallereal, Instituto Thomas Jefferson" />
  ...
  <div class="wrapper theme-1-active pimary-color-green">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							<img class="logo-portal" src="{{asset('/images/portal/logoitj_login_blue.svg')}}" alt="ITJ Vallereal"/>
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="zmdi zmdi-landscape mr-20"></i><span class="right-nav-text">Principal</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="dashboard_dr" class="collapse collapse-level-1">
						<li>
							<a class="active-page" href="index.html">Usuarios</a>
						</li>
						<li>
							<a href="index2.html">Secciones</a>
						</li>
						<li>
							<a href="index3.html">Departamentos</a>
						</li>
						<li>
							<a href="index4.html">Ubicaciones</a>
						</li>
						<li>
							<a href="index5.html">Inventario</a>
						</li>
					</ul>
				</li>
				<li>
