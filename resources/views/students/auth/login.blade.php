...
@section('content')
<!-- login students -->
<div class="page-wrapper login-students pa-0 ma-0 auth-page" style="background-image: url({{ asset('/images/auth/students/bg-login-students-b.svg') }})">
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="mb-30">
							...
							<h6 class="text-center nonecase-font text-white">Acceso a Estudiantes</h6>
						</div>
						<div class="form-wrap">
